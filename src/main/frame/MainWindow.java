...
public class MainWindow extends JFrame
{
    ...
    public MainWindow(String xmlFolder)
    {
        super("Main window");
        try
        {
...
//            UIManager.setLookAndFeel("com.stefankrause.xplookandfeel.XPLookAndFeel");
    ...
    private void setGUIDetails()
    {
        ...
        setLocation((dim.width - WINDOW_WIDTH) / 2,
                    (dim.height - WINDOW_HEIGHT) / 2);
...
//        lookAndFeelMenu.add(xpLNF);
     ...
     */
    private void setButton(JToolBar toolBar,
                           String gif, 
                           String tooltipText,
    ...
    private XMLElement[] loadXML(String xmlFolder) throws Exception
    {
        ...
        if (folder.isDirectory())
        {
            ...
            if (filesTotal > 0)
            {
                ...
                {
                    Document doc = builder.parse(xmlFolder + 
                                                 File.separator + 
                                                 filenames[fileIndex]);
    ...
    public void buildTreeModel(int depth, 
    ...
    private void moveSelectedElements()
    {
        ...
        for(i=0; i<length; i++)
        {
            DefaultMutableTreeNode node = 
                (DefaultMutableTreeNode)selected[i].getLastPathComponent();
    ...
    protected class GenerateXMLAction implements ActionListener
    {
        public void actionPerformed(ActionEvent e)
        {
            try
            {
                ...
                {
                    JOptionPane.showMessageDialog(getThisComponent(), 
                            "Result XML file not specified");
                    return;
                }
